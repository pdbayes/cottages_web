  ...
  <div class="container">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Tregrill Farm Cottages</a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="./info.html#weather">Weather</a></li>
                <li><a href="./info.html#holiday">Your Holiday</a></li>
                <li><a href="./info.html#whats_on">Whats On</a></li>
                <li><a href="info.html#access">Accessibility</a></li>
              </ul>
            </li>
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="./things_to_do.html#walking">Walking</a></li>
				<li><a href="./things_to_do.html#beaches">Beaches</a></li>
				<li><a href="./things_to_do.html#gardens">Gardens and History</a></li>
				<li><a href="./things_to_do.html#animal">Animal Attractions</a></li>
				<li><a href="./things_to_do.html#active">Active and Adventure</a></li>
				<li><a href="./things_to_do.html#other">Other</a></li>
               
              </ul>
            </li>
            <li><a href="./covid_info.html">Covid-19 Information</a></li>
          </ul>
...
<div class="col-xs-12">
<h1>Find Us</h1>
<p>Tregrill Farm Cottages are located just 10 minutes from the A38. To make finding us easier, we have created custom POIs for sat nav users.</p>
<p>To download the POI for your sat nav, simply click on the file name next to your make of sat nav and then save the file. Follow the manufacturers instructions on how to install the POI.</p>

<table border="0">
<tr>
<td class="col-md-6">Tom Tom   </td>
<td><a href="http://www.tregrillfarmcottages.co.uk/poi/TregrillFarmCottages.ov2" target="_self">OV2 File</a></td>
</tr>
<tr>
<td class="col-md-6">Garmin</td>
<td><a href="http://www.tregrillfarmcottages.co.uk/poi/TregrillFarmCottages.csv" target="_self">CSV File</a></td>
</tr>
<tr>
<td class="col-md-6">Navman</td>
<td><a href="http://www.tregrillfarmcottages.co.uk/poi/TregrillFarmCottages Nav.csv" target="_self">CSV File</a></td>
</tr>
</table><br />
The co-ordinates are: +50° 26' 35.59", -4° 25' 13.71" <br />
<p>We have also created comprehensive directions in both word and PDF formats that you can download and print out:<br />
<a href="holiday cottage docs/Tregrill Farm Holiday Cottage Directions.doc">Word</a><br />
<a href="holiday cottage docs/Tregrill Farm Holiday Cottage Directions.pdf">PDF</a></p>
...
<div class="embed-responsive embed-responsive-4by3">
  <iframe src="https://storage.googleapis.com/maps-solutions-ixo3w0nsee/locator-plus/micy/locator-plus.html"
...
<iframe src="https://www.meteoblue.com/en/weather/widget/three/menheniot_united-kingdom_2642749?geoloc=fixed&nocurrent=0&noforecast=0&days=7&tempunit=CELSIUS&windunit=MILE_PER_HOUR&layout=image"  frameborder="0" scrolling="NO" allowtransparency="true" sandbox="allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox" style="width: 805px;height: 617px"></iframe><div><!-- DO NOT REMOVE THIS LINK --><a href="https://www.meteoblue.com/en/weather/forecast/week/menheniot_united-kingdom_2642749?utm_source=weather_widget&utm_medium=linkus&utm_content=three&utm_campaign=Weather%2BWidget" target="_blank">meteoblue</a></div>
</div>
<div class="col-xs-12 col-md-12">
<p.class ="right">
Cornwall has a temperate Oceanic climate and as a result of its southerly latitude and the influence of the Gulf Stream has the mildest and sunniest climate in the United Kingdom.</P>
 <p.class ="right">The average annual temperature in Cornwall ranges from 11.6 °C (53 °F) on the Isles of Scilly to 9.8 °C (52 °F) in the central uplands. Winters are amongst the warmest and shortest in the country due to the southerly latitude and moderating effects of the warm ocean currents. The resultant early spring and long growing season means that Cornwall is home to an abundant array of quality produce, and also that we start to see the early crops of vegetables and flowers before the rest of the country.</p>
<p.class ="right">  Frost and snow are very rare. The surrounding sea and its southwesterly position mean that Cornwall's weather is relatively changeable.<br/></p>
<p.class ="right">Cornwall is one of the sunniest areas in the UK, with over 1541 hours of sunshine per year, with the highest average of 7.6 hours of sunshine per day in July. The moist, mild air coming from the south west brings higher amounts of rainfall than in eastern Great Britain, at 1051 to 1290 mm (41.4 to 50.8 in) per year, however not as much as in more northern areas of the west coast. This rain along with all that lovely sun helps to make our county so green and beautiful.</p>
<p.class ="right"> The Gulf Stream, bringing warm air from the Caribbean north-east toward Europe, makes Cornwall's weather distinctly milder than other places in the world at the same latitude, such as Newfoundland. Also due to the Gulf Stream, Cornwall has the UK's only area of sub-tropical climate. This sub-tropical nature has resulted in a number of botanical gardens, such as <a href="http://www.trebahgarden.co.uk/" target="_blank" title="Link to Trebah Gardens - Opens a new window.">Trebah</a> and the Lost Gardens of <a href="http://www.heligan.com/" target="_blank" title="Link to Heligan - opens in new window.">Heligan</a>.</p>
<p.class ="right">Pendennis Point in Falmouth is the warmest place on mainland Great Britain, with an average temperature of 11.4°C (52.5°F).
...
<div class="col-sm-12">
<a name="whats_on"></a>
<h1 id ="whats_on">What's on</h1>
<div id="satnav" class ="hidden-xs hidden-sm">
<iframe width="768" height="400px" style="border:none;" scrolling="no" vspace="0" hspace="0" frameborder="0" marginwidth="0" marginheight="0" src="https://www.visitcornwall.com/widget/whats-on">
You need a Frames Capable browser to view this content.
</iframe>   
</div> 


<div class="embed-responsive embed-responsive-4by3 visible-xs visible-sm">
<iframe class="embed-responsive-item" style="border:none;" scrolling="yes" vspace="0" hspace="0" frameborder="0" marginwidth="0" marginheight="0" src="https://www.visitcornwall.com/widget/whats-on">
</iframe>   
</div>
</div>
</div> 
...
<p>Finding accommodation that meets the needs of you and your party is key to a relaxing and enjoyable holiday. To help you decide whether our cottages meet your needs we have prepared the access statements for each cottage that describe the cottage layout and physical environment.</p>
<p>These access statements do not contain personal opinions as to our suitability for those with access needs, but aims to accurately describe the facilities and services that we offer all our guests.</p> 
<p>Please click on the links below to view the accessibility statement for the cottage you are interested in.</p>
<span class="glyphicon glyphicon-open-file" aria-hidden="true"></span><a href="access/Access Statement for Deco.pdf"> Deco</a><br />
<span class="glyphicon glyphicon-open-file" aria-hidden="true"></span><a href="access/Access Statement for New England.pdf"> New England</a><br />
<span class="glyphicon glyphicon-open-file" aria-hidden="true"></span><a href="access/Access Statement for Moderno.pdf"> Moderno</a><br />
<span class="glyphicon glyphicon-open-file" aria-hidden="true"></span><a href="access/Access Statement for Provence.pdf"> Provence</a><br />
 </div>
 </div>
